 ...
 */
public class VerifikasiFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
        ...
        if (g.getBerita() != null) {
            ...
            swipe.post(new Runnable() {
                           ...
                           public void run() {
                               ...
                               if (!isOnline())
                                   Toast.makeText(VerifikasiFragment.this.getContext(), "Cek Koneksi Internet Anda", Toast.LENGTH_SHORT).show();
                               else
                                   setDetailVerif();
